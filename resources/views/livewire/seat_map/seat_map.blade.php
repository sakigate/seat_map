...
<div class="m-5 w-full" wire:poll.5s="refreshSeats">
    <h1 class="text-3xl font-bold text-center">あの人どこ？オフィスマップ</h1>
    <div class="flex justify-center w-full m-5">
        <!-- 左：オフィス選択と社員名簿 -->
        <div class="w-1/3 p-3 m-5">
            <!-- 左上：オフィス選択 -->
            <div class="space-y-3 frex">
                <h2 class="text-2xl font-bold text-center mb-4">オフィス選択</h2>
                <div class="mb-3">
            ...
            <!-- 左上：社員名簿 -->
            <h2 class="text-2xl font-bold text-center mb-4">社員名簿</h2>
            <div class="border rounded relative overflow-y-auto frex">
        ...
        <!-- 右：座席表 -->
        <div class="w-2/3 overflow-x-auto border rounded p-3 m-5">
            <h2 class="text-center text-3xl font-bold">{{ $currentOffice->office_name }}の座席表</h2>
